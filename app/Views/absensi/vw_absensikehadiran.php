            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Absensi Kehadiran Peserta</h4>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('absensi/prosesabsensikehadiran') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <!-- <video id="my_camera1" playsinline height="370"></video> -->
                                    <br />
